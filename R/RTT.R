...
RTT <- function(app_name = "RTT",
  ...
  musicassessr::make_musicassessr_test(
                         ...
                         admin_password = "demo",
                         opt = musicassessr::musicassessr_opt(musicassessr_aws = musicassessr_aws, setup_options = musicassessr::setup_pages_options(input_type = "midi_keyboard", headphones = FALSE),
                                                midi_input = TRUE)
  )
